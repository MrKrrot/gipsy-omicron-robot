...
motor MotorL4 = motor(PORT14, ratio6_1, false);
motor_group MotoresL = motor_group(MotorL1, MotorL2, MotorL3, MotorL4);

// Motores Derecha
motor MotorR1 = motor(PORT20, ratio6_1, true);
motor MotorR2 = motor(PORT19, ratio6_1, false);
motor MotorR3 = motor(PORT18, ratio6_1, false);
motor MotorR4 = motor(PORT16, ratio6_1, true);
